            ...
            <div class="card shadow-sm p-4">
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>
                                ...
                                <td>
                                    <a href='carrinho.php?edit={$row['id']}' class='btn btn-warning btn-sm'>Editar</a>
                ...
                ?>
                    ...
                    <form action="processa.php" method="POST">
                        ...
                        <a href="carrinho.php" class="btn btn-secondary">Cancelar</a>
                    </form>
                <?php
                }
                ...
                <div class="col-12 d-flex justify-content-center">
                    <a href="formulario.php" class="btn btn-primary btn-lg w-50 mt-1">Comprar novo Produto</a>
                </div>
                <div class="col-12 d-flex justify-content-center">
                    <a href="pedido.php" class="btn btn-secondary btn-lg w-50 mt-1">Finalizar compra</a>
                </div>
            </div>
        </div>
    </div>
