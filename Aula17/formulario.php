...
<head>
    ...
    <style>
        body {
            background: linear-gradient(to right, #fceabb,rgb(0, 66, 248));
    ...
    <div class="container d-flex justify-content-center align-items-center min-vh-100">
        <div class="w-100" style="max-width: 900px;">
            ...
            <div class="text-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="160" height="160" fill="currentColor" class="bi bi-car-front" viewBox="0 0 16 16">
